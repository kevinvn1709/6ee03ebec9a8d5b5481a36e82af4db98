    ...
    <form class="login-form" action="index.html" method="post">
        ...
        <div class="login-options">
            ...
            <ul class="social-icons">
                <li>
                    <a class="social-icon-color facebook" data-original-title="facebook" href="javascript:;" onclick="loginFacebook()"></a>
                </li>
                <li>
